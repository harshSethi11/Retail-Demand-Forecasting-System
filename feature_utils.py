...
def compute_features_from_recent(recent_sales, price=1.0, promo_flag=0):
    """
    recent_sales: list or array-like of past sales in chronological order (oldest to newest).
